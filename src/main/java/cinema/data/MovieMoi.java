...
public class MovieMoi {           //creation de la classe movie
	...
	//constructors
	public MovieMoi(String title, int year) {                  // m�thode permettant de cr�er un objet de la classe cr��e (constructor)
		this(title, year, 0);
	}

	public MovieMoi(String titre, int annee, int duration) {
		this(titre, annee, duration, null);
	}

	
	public MovieMoi(String titre, int annee, PersonMoi director) {
		this(titre, annee, 0, director);
	}
	
	
	public MovieMoi(String titre, int annee, int duration, PersonMoi director) {
		super();
